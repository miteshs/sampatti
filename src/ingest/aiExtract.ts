...
- account_type follows the INSTITUTION, not the instruments: a bank's FD/term-deposit summary = "bank"; a US/foreign brokerage (values in USD) = "foreign_broker"; an Indian broker's stock holdings = "demat"; a fund house / RTA fund statement = "mutual_fund"; a PMS / portfolio-management / AIF statement = "pms_aif".
