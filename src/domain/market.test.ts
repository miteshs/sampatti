...
import {
  ...
  holdingSig, resolverFromData, type ResolverData,
} from "./market";
...
describe("resolverFromData (resolve by stable signature)", () => {
  ...
  it("resolves a holding by symbol+class+currency, not by id", () => {
  ...
  it("a re-imported holding (new id, same symbol) still resolves via the signature", () => {
