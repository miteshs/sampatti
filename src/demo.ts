  ...
  const { accounts, holdings } = build([
    {
      ...
      items: [
        ["Reliance Industries", "indian_equity", 3_500_000, { costBasis: 2_100_000, units: 1180, buyDate: "2019-07-12" }],
        ["HDFC Bank", "indian_equity", 2_800_000, { costBasis: 1_700_000, units: 1650, buyDate: "2020-03-20" }],
        ["Infosys", "indian_equity", 2_200_000, { costBasis: 900_000, units: 1400, buyDate: "2018-11-05" }],
        ["TCS", "indian_equity", 1_800_000, { costBasis: 1_200_000, units: 470, buyDate: "2021-01-18" }],
        ["ICICI Bank", "indian_equity", 1_600_000, { costBasis: 750_000, units: 1300, buyDate: "2020-09-10" }],
        ["Bajaj Finance", "indian_equity", 1_500_000, { costBasis: 1_100_000, units: 200, buyDate: "2022-06-01" }],
        ["Larsen & Toubro", "indian_equity", 1_200_000, { costBasis: 650_000, units: 330, buyDate: "2021-08-22" }],
        ["Asian Paints", "indian_equity", 1_000_000, { costBasis: 700_000, units: 350, buyDate: "2019-12-02" }],
        ["Titan Company", "indian_equity", 900_000, { costBasis: 400_000, units: 250, buyDate: "2020-05-15" }],
        ["Zomato", "indian_equity", 600_000, { costBasis: 660_000, units: 2200, buyDate: "2025-11-20" }],
      ],
    },
    {
      ...
      taxTreatment: "taxable", region: "India", currency: "INR", asOf: "2026-05-31",
      items: [
        ["Parag Parikh Flexi Cap Fund", "equity_mf", 5_500_000, { costBasis: 3_000_000, buyDate: "2019-04-01" }],
        ["Mirae Asset Large Cap Fund", "equity_mf", 4_500_000, { costBasis: 2_400_000, buyDate: "2018-02-10" }],
        ["Axis Midcap Fund", "equity_mf", 3_000_000, { costBasis: 1_900_000, buyDate: "2021-03-15" }],
        ["SBI Small Cap Fund", "equity_mf", 2_500_000, { costBasis: 1_400_000, buyDate: "2022-07-01" }],
        ["HDFC Index Fund — Nifty 50", "index_etf", 3_500_000, { costBasis: 2_200_000, buyDate: "2020-01-08" }],
        ["UTI Nifty Next 50 Index Fund", "index_etf", 1_500_000, { costBasis: 1_050_000, buyDate: "2021-11-11" }],
        ["Axis Long Term Equity (ELSS)", "elss", 1_800_000, { costBasis: 1_100_000, buyDate: "2020-02-20" }],
      ],
    },
    {
      ...
      taxTreatment: "taxable", region: "India", currency: "INR", asOf: "2026-05-31",
      items: [
        ["HDFC Corporate Bond Fund", "debt_mf", 4_000_000, { costBasis: 3_500_000, buyDate: "2023-06-01" }],
        ["ICICI Prudential Liquid Fund", "debt_mf", 2_500_000, { costBasis: 2_350_000, buyDate: "2024-01-10" }],
      ],
    },
    {
      ...
      items: [["Consistent Compounders Portfolio", "indian_equity", 8_500_000, { costBasis: 6_000_000, buyDate: "2021-04-01" }]],
    },
    {
      name: "Edelweiss AIF", institution: "Edelweiss", accountType: "pms_aif",
      taxTreatment: "taxable", region: "India", currency: "INR", asOf: "2026-03-31",
      defaultAssetClass: "other",
      items: [["Edelweiss Alternative Yield Fund (Cat-II AIF)", "other", 5_000_000, { costBasis: 4_500_000 }]],
    },
    {
    ...
    },
    {
      ...
      taxTreatment: "taxable", region: "India", currency: "INR", asOf: "2026-05-31",
      items: [
        ["Sovereign Gold Bonds (2021-22)", "gold_sgb", 2_000_000, { costBasis: 900_000, buyDate: "2021-08-01" }],
    ...
    },
    {
      ...
      items: [
        ["Microsoft Corp (RSU)", "us_equity", 60_000, { costBasis: 38_000, units: 130, buyDate: "2022-02-15", currency: "USD" }],
        ["Microsoft Corp (ESPP)", "us_equity", 25_000, { costBasis: 26_500, units: 54, buyDate: "2025-09-01", currency: "USD" }],
      ],
    },
    {
